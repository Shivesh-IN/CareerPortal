      ...
      <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24'>
        ...
        <div className='text-center max-w-3xl mx-auto mb-16 animate-fadeInUp'>
          <h1 className='mb-3 font-serif text-3xl leading-tight font-bold text-[#1c1d20] md:text-4xl lg:text-5xl'>
            Get Interview Ready With <span className='text-orange-500'>NUCareer</span>
          </h1>
          ...
          <div className='flex gap-4 justify-center flex-wrap'>
            {!isAuthenticated ? (
              ...
              <button onClick={() => openModal('features')} className='px-8 py-3 border-2 border-orange-500 text-orange-500 rounded-lg font-semibold hover:bg-orange-50 transition-all'>
                Explore Features
              </button>
            )}
          </div>
        ...
        <div className='bg-orange-400 rounded-2xl p-12 shadow-lg mb-20 border-2 border-orange-500'>
          <h2 className='mb-3 font-serif text-3xl leading-tight font-normal text-white md:text-4xl lg:text-5xl mb-8 text-center'>Why Choose NUCareer?</h2>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-8'>
            <div>
              ...
              <p className='text-slate-600 text-sm'>NUCareer is dedicated to helping students prepare for their dream interviews with AI-powered tools and expert mentorship.</p>
            </div>
            <div>
              <h3 className='font-semibold text-slate-900 mb-4'>Contact</h3>
              <p className='text-slate-600 text-sm'>Email: support@nucareer.com</p>
          ...
          <div className='border-t border-gray-200 pt-8 text-center'>
            <p className='text-slate-600 text-sm'>
              © 2025 NUCareer. Created at NIIT UNIVERSITY. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
