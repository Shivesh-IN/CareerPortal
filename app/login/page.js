    ...
    <div className='min-h-screen flex items-center justify-center bg-white p-4'>
      <div className='w-full max-w-md card-gradient rounded-2xl shadow-2xl p-8 animate-fadeInUp'>
        ...
        <div className='text-center mb-8'>
          <h1 className='text-3xl font-bold text-orange-500 mb-2'>NUCareer</h1>
        ...
        <div className='mb-4 p-3 bg-blue-50 border-2 border-blue-200 rounded-lg text-blue-700 text-xs'>
          <p className='font-semibold'>Demo Login:</p>
          <p>Email: <code className='bg-blue-100 px-1 rounded'>admin</code></p>
